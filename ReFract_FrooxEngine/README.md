...
2. Download the latest release ZIP file (e.g., `Noble-ReFract_FrooxEngine-1.0.0.zip`) from the [Releases](https://github.com/Noble/ReFract_FrooxEngine/releases) page.
